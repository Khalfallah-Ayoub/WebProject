  ...
  try {
    ...
    for (const [langKey, langData] of Object.entries(programmingLanguages)) {
      ...
      for (const question of langData.questions) {
        ...
        console.log(`   [Q] Added question: ${question.title.substring(0, 50)}...`);
      }
    }
    ...
    console.log("[*] Total Questions: " + Object.values(programmingLanguages).reduce((sum, lang) => sum + lang.questions.length, 0));
